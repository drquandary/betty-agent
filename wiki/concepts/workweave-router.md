...
related: [dflash, betty-ai-agent, jeffrey-vadala, parcc-skills-modules]
status: tentative
---
...
## Sources
- [[2026-06-26-teams-chats-digest]] — Jeffrey shares github.com/workweave/router; floats pairing it with dflash for fast sub-agent tasks
