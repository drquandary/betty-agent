---
type: source
tags: [teams, parcc, ceph, storage, downtime, vendor]
created: 2026-06-26
updated: 2026-06-26
related: [betty-storage-architecture, jaime-combariza, kenneth-chaney]
status: current
---
...
## One-line summary
PARCC Group: the `/ceph` remediation will require a coordinated downtime — AHEAD asked for timing/duration, groups holding /ceph data must be contacted, and the team is weighing an earlier meeting (Jaime offered 9 AM) to leave time to reach out to faculty + AHEAD.
