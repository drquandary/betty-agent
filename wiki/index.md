...
- [[2026-07-07-teams-chats-digest]] — small cycle: Ken reports **VAST snapshots starting to populate** — visible now via `/usr/bin/python3 $(which parcc_quota.py) --snapshots` (adds a Snapshots column; actively-used paths show data, e.g. chaneyk/test 13.18 GB, others still ramping).
