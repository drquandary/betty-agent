...
- [[2026-07-01-teams-chats-digest]] — Bradley 1:1: ParccSkills 404 for Ryan still unresolved ("idk why"); **Claude Science RSE-positioning** — respond to the "grad-students 10x" claim, demo at next sync. **2nd pull (10:12):** first tokens-as-a-service beta lab named (Dr. Anjan Chatterjee, Neurology) + downtime-broadcast need; **HOME-dir perms policy** (0750 default, 0700/0750 only, nothing in "other", share via project dirs)
