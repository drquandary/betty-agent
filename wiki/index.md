...
- [[vast-storage]] — NFS 4.2 over RDMA on InfiniBand, 40 storage endpoints; NFSv4 ACLs via `nfs4_setfacl`; **per-project protected-path snapshots (ColdFront-controlled, `parcc_quota.py --snapshots`, 7/6)** (4 sources)
