...
- [[slurm-on-betty]] — Slurm 24.11.7 with backfill scheduler; **b200 "license" gating (7/7 desync stranded 8 idle nodes → root-caused to per-MIG-slice license accounting; `b200` cap raised to 2000)** (2 sources)
