...
- [[parcc-skills-modules]] — agent "skills" as discoverable units: Ken's skills-from-Spack generator + Lmod-loadable tree, jvadala's ParccSkills repo (+ roadmap: data-packaging & MWE skills, skill-lint, rule-via-hooks-not-CLAUDE.md lore); **skill anatomy = text + `.sh` hooks; Ryan's human-legible-vs-machine-readable "parity" standards proposal (7/1)** (tentative, 4 sources)
